...
public class ExcelToXml {
            ...
            for (final Row row : sheet) {
                ...
                for (final Cell cell : row) {
                    ...
                    if (cellStr.startsWith("##")) {  //第一种情况##Role
                        ...
                        isFieldIdLabel = true;
                        //第三种情况字段名称roleId*，description存进fields集合
    ...
    public static void main(final String[] args) throws Exception{
        ...
        //String xmlpath= Objects.requireNonNull(Thread.currentThread().getContextClassLoader().getResource("XML/Ditu.xml")).getPath();
        generateXml("D:/test/Skill.xlsx", "D:/test/Skill.xml");
    }
}
